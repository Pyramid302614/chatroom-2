...
function ws_config() {
    ...
    ws.onclose = () => {
        ...
        "<br\><br\><button onclick=\"if(!ws) location.reload();\">Reload Page</button>"+
        "&nbsp;|&nbsp;<button onclick=\"if(!ws) { ws = new WebSocket('ws://&&host:&&port');ws_config(); }\">Reconnect to websocket</button><hr>";
    }
}
